...
import org.example.BookMyShow.controllers.TheatreController;
import org.example.BookMyShow.entities.*;
...
public class BookMyShowApp {
    ...
    private void initialize(){
        ...
        Screen pvrScreen1 = new Screen("2", createSeats());
    ...
    private void userFlow() {
        // User enters system
        User user = new User("U1", "Pavesh");
        System.out.println("User logged in: Pavesh");
